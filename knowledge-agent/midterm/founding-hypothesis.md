...
Area | Current approach | Rooted in | What we build  
Gap detection (from questions + low-confidence AI answers), prioritized gap list, AI draft generation, human review UI, single path to publish into KB | H3, H4, H5  
